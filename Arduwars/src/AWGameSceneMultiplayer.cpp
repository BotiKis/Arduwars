...
void AWGameSceneMultiplayer::didAppear(EngineBoy<GameContext, GameSceneID> & engine)
{
  //reset players
  this->player1.reset();
  this->player2.reset();
...
void AWGameSceneMultiplayer::willDisappear(EngineBoy<GameContext, GameSceneID> & engine)
{
